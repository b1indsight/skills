...
| [`codex-tool-constraints`](codex-tool-constraints/) | Mandatory constraints for Codex tool usage. Use for every task that reads files or otherwise invokes tools, so tool calls stay focused and avoid loading unnecessary data. |
